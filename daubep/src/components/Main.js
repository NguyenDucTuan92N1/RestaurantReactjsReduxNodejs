    ...
    <div className="container">
      <div className="row justify-content-between">
        ...
        <div className="col-xl-6 col-lg-6 col-md-6">
          <a href="#" className="btn full-menu f-right">Full Order</a>
        </div>
      </div>
      <div className="row ">
              ...
              <div className="single-cat single-cat2 text-center mb-40">
                ...
                <div className="cat-cap">
                  ...
                  <div className="container-fluid">
                    <div className="row">
                      <div className="col-6">
                        <a href="#" className="list-group-item list-group-item-action list-group-item-success text-success">Hiện</a>
                      </div>
                      <div className="col-6">
                        <a href="#" className="list-group-item list-group-item-action list-group-item-danger text-danger ">Ẩn</a>
                      </div>
                    </div>
                    <div className="row mt-2">
                      <div className="input-group">
                        ...
                        <input type="text" name="quant[1]" className="form-control input-number" disable defaultValue={6} min={1} max={10} />
                        <span className="input-group-btn">
                  ...
                  <div className="container-fluid">
                    ...
                    <div className="row mt-2">
                      <div className="input-group">
                        ...
                        <input type="text" name="quant[1]" className="form-control input-number" disable defaultValue={4} min={1} max={10} />
                        <span className="input-group-btn">
                          <button type="button" className="btn btn-default btn-number" data-type="plus" data-field="quant[1]">
                            <span className="fa fa-plus" />
                          </button>
