                    ...
                    <div className="container">
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-4 col-sm-8">
                            ...
                            <ul className="mb-20">
                                ...
                                <li className="number2"><a href="#"><span className="__cf_email__" data-cfemail="6f1d0a1c1b0e1a1d0c0057562f08020e0603410c0002">[email&nbsp;protected]</span></a></li>
                            </ul>
                            </div>
                        </div>
                        </div>
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            ...
                            <div className="footer-copy-right text-center">
                                Copyright © All rights reserved | This template is made with <i className="fa fa-heart color-danger" aria-hidden="true" /> by <a href="https://colorlib.com/" style={{color: 'black'}} target="_blank" rel="nofollow noopener">Colorlib</a>
                            </div>
                            </div>
                        </div>
                        </div>
